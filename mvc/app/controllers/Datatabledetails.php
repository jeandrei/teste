<?php 
    class Datatabledetails extends Controller{
        public function __construct(){            
            $this->dataModel = $this->model('Datatabledetail');
        }

        //Carrega o view index
        public function index(){             
            
            $this->view('datatabledetails/index');         
        }   
        ...
        public function datatable(){  
            ...
            foreach ($empRecords as $row) {
                $data[] = array(
                    ...
                    "pessoaCelular" =>$row->pessoaCelular,
                    "pessoaTelefone"=>$row->pessoaTelefone,
                    "pessoaUf"=>$row->pessoaUf,                    
                    "pessoaNascimento"=>$row->pessoaNascimento,
                    "pessoaDeficiencia"=>$row->pessoaDeficiencia,
                    "pessoaCpf"=>$row->pessoaCpf,
                    "pessoaNumero"=>$row->pessoaNumero,
